...
-- alter table airdrop_records drop index UniquePolyBridgeAddress;
alter table airdrop_records add constraint UniquePolyBridgeAddress unique (airdrop_id, address);
