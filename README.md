...
"http://localhost:8787/v1/poly-bridge/voteRewardProcesses/"
```
...
```shell
curl -u {username}:{passwd} -H "Content-Type: application/json" -X POST \
-d '{}' "http://localhost:8787/v1/poly-bridge/createVoteRewardProcess?proposalId=6&onChainDisabled=true"
```
...
```url
http://localhost:8787/v1/poly-bridge/voteRewardProcesses/{processId}
```
...
```url
http://localhost:8787/v1/poly-bridge/exportRewardCsv?processId={processId}
```
...
```url
http://localhost:8787/v1/poly-bridge/exportPolyBridgeJson?processId={processId}
```
...
"http://localhost:8787/v1/poly-bridge/revokeOnChain?airdropId=12&root=0xbcc6b34299c01419d978fbd9ea8c61f37e6bc5e3e4e6c14b917946733bcc87b2"
```
...
```shell
curl -u {username}:{passwd} -H "Content-Type: application/json" -i -X POST \
"http://localhost:8787/v1/poly-bridge/revokeOnChainByProcessId?processId=8"
```
...
```shell
curl -u {username}:{passwd} -H "Content-Type: application/json" -i -X POST \
-d '{}' "http://localhost:8787/v1/poly-bridge/resetVoteRewardProcess?processId=25"
```
